...
LANGFLOW_ID = "ce2020fd-42fd-4bd3-9b59-2d93aca42c3f"
FLOW_ID = "306e6115-f774-4a2d-a4bf-fdc4f2e0ed5f"
APPLICATION_TOKEN = os.getenv("API_AUTHENTICATION_TOKEN")
ENDPOINT = "ask-ai"  # The endpoint name of the flow

# You can tweak the flow by adding a tweaks dictionary
# e.g {"OpenAI-XXXXX": {"model_name": "gpt-4"}}
TWEAKS = {
    "TextInput-a1tan": {"input_value": "what is the best back workout routine for me"},
    "Prompt-OhHE4": {},
    "OpenAIModel-zooY1": {},
